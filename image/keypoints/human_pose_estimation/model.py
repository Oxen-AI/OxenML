...
class ImageKeypointsModel():
  ...
  def _build_v3_fast(self):
    ...
    conv_branch_f2 = keras.layers.Conv2D(hidden_size_middle, 1, padding="same")(features_2)
    conv_branch_f2 = keras.layers.BatchNormalization()(conv_branch_f2)
    conv_branch_f2 = keras.layers.Activation("relu")(conv_branch_f2)

    pool_branch_f2 = keras.layers.AveragePooling2D(pool_size=(2,2), strides=(16, 20))(features_2)
    ...
    combined_f2 = keras.layers.Conv2D(hidden_size_middle, 1, padding="same")(combined_f2)
    combined_f2 = keras.layers.UpSampling2D(2)(combined_f2)
    ...
    outputs = keras.layers.Conv2D(self.num_outputs, 1, activation="sigmoid", padding="same")(x)
