...
from oxen.image.keypoints.human_pose import CocoHumanKeypointsDataset, OxenHumanKeypointsDataset
...
def test_convert_coco():
    ...
    face_keypoints = [
        ...
        coco_dataset.get_annotations(file).annotations[0].get_joint_keypoint(Joint.RIGHT_EYE),
        coco_dataset.get_annotations(file).annotations[0].get_joint_keypoint(Joint.LEFT_EAR),
        coco_dataset.get_annotations(file).annotations[0].get_joint_keypoint(Joint.RIGHT_EAR)
    ]
